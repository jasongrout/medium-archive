...
def main():
    ...
    parser("hugo", help="build a Hugo site in <out>/site-hugo/ from the "
                        ...
                        "self-contained theme, and a redirect map. Or name "
                        "a real theme in site.json's hugo section -- the "
                        "Dream theme (hugo-theme-dream, needs Hugo >= "
                        "0.158) gets first-class support: summary-card "
                        "covers from each post's images, per-post bylines, "
                        "its built-in search page, archives timeline, and "
                        "a site avatar. Render with `hugo server` inside "
                        "<out>/site-hugo/ (https://gohugo.io); with the "
                        "built-in theme, `pagefind --site public` adds "
                        "search after `hugo`")
