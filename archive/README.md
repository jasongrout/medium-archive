...
Generated by `medium-archive` on 2026-08-24. This directory is a self-contained
...
* `site/` (optional) is a **MyST site** derived from the converted posts by
  ...
  `favicon.svg` (that repo's official favicon, the all-orange mark) as
  the browser-tab icon, and
