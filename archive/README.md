...
Generated by `medium-archive` on 2026-09-04, and rewritten by every
`convert` run, so corrections to it belong in the tool rather than in
this file. This directory is a self-contained archive of the
publication, intended to support migrating the blog off Medium. It has
two layers, raw and derived, plus a few hand-written files that belong
with the archive.
...
## Regenerating
    ...
    medium-archive myst --out .             # rebuild site-myst/ from posts/
    medium-archive hugo --out .             # rebuild site-hugo/
    medium-archive pelican --out .          # rebuild site-pelican/
